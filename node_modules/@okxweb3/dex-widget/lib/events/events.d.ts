...
import { OnFulfilledOrderPayload, OnPostedOrderPayload, OnCancelledOrderPayload, OnExpiredOrderPayload, OnPresignedOrderPayload } from './orders';
...
export declare type OkxEventPayloads = OkxEventPayloadMap[OkxEvents];
