...
export declare enum WidgetProviderEvents {
    PROVIDER_ON_EVENT_CONNECT = "PROVIDER_ON_EVENT_CONNECT",
    PROVIDER_ON_EVENT = "PROVIDER_ON_EVENT",
    PROVIDER_ONEVENT_WALLET_SATUS = "PROVIDER_ONEVENT_WALLET_SATUS",
    NO_WALLET_CONNECT = "NO_WALLET_CONNECT"
}
declare type OkxSwapWidgetParams = any;
...
export declare type OkxSwapTheme = 'dark' | 'light';
/**
...
export declare const WIDGET_PALETTE_COLORS: readonly ["primary", "background", "paper", "text", "danger", "warning", "alert", "info", "success"];
export declare type OkxSwapWidgetPaletteColors = typeof WIDGET_PALETTE_COLORS[number];
export declare type OkxSwapWidgetPaletteParams = {
    [K in OkxSwapWidgetPaletteColors]: string;
};
export declare type OkxSwapWidgetPalette = {
    baseTheme: OkxSwapTheme;
} & OkxSwapWidgetPaletteParams;
...
export declare type WalletType = 'metamask' | 'phantom' | 'walletconnect';
...
export declare type WidgetMethodsEmitPayloads = WidgetMethodsEmitPayloadMap[WidgetMethodsEmit];
export declare type WidgetMethodsListenPayloads = WidgetMethodsListenPayloadMap[WidgetMethodsListen];
...
export declare type WidgetMethodsEmitListener<T extends WidgetMethodsEmit> = T extends WidgetMethodsEmit ? {
    event: T;
    handler: WidgetMethodHandler<T>;
} : never;
export declare type WidgetMethodHandler<T extends WidgetMethodsEmit> = (payload: WidgetMethodsEmitPayloadMap[T]) => void;
...
export declare type ProviderRpcResponsePayload = {
    rpcResponse: JsonRpcResponse;
};
export declare type JsonRpcResponse = JsonRpcRequestMessage | JsonRpcErrorResponseMessage | JsonRpcSucessfulResponseMessage;
...
export declare const ChainName: typeof ProviderType;
export declare type TWalletTypeRecord = Record<ProviderType, WalletType>;
